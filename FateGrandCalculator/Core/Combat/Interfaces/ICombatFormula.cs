...
namespace FateGrandCalculator.Core.Combat.Interfaces
{
    public interface ICombatFormula
    {
        ...
        Task<PartyMember> AddPartyMember(List<PartyMember> party, ChaldeaServant chaldeaServant, CraftEssence chaldeaCraftEssence, float additionalDamageBonus = 0.0f);
    }
}
